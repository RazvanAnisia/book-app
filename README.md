...
- To get the project running locally, make sure to `npm install` first after pulling
- Then run `npm run dev` to start the development server
- There should be no errors, and the app should be available on http://localhost:5173/
- Recommended editors: [VS Code](https://code.visualstudio.com/)
